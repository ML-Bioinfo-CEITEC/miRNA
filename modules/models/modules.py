...
class SimpleCNN(torch.nn.Module):
    def __init__(self, num_layers=5, num_channels_initial=8, kernel_size=4, dilation=1, padding=0):
        super().__init__()
        ...
        for i in range(num_layers):
            ...
            block = torch.nn.Sequential(
                # stride CHANGE from 1 to 4
                torch.nn.Conv1d(in_channels, out_channels, kernel_size=kernel_size, stride=4, dilation=dilation, padding=padding),
                torch.nn.ReLU(),
